  ...
  latestAnimals.forEach((animal) => {
    ...
    card.innerHTML = `
      <div class=" w-full h-auto overflow-hidden">
        <img src="assets/images/animals/${animal.id}.jpg" alt="${animal.name}" classn="w-full object-cover">
      </div>
      <div class="flex flex-col px-4 pb-4">
          ...
          <div class="text-center mt-3">
            <a href="fiche-animal.html?id=${animal.id}" class="text-white px-4 py-1 mx-auto bg-[#698018] hover:bg-[#E2992A] transition-all duration-300">EN
              SAVOIR PLUS</a>
            </div>
      </div>`;
