...
const dogAdoptionCosts = `
  <h4 class="text-3xl uppercase font-medium mb-2 ml-1">Chiens</h4>
  <div class="join join-vertical w-full rounded-none">
    ...
    <div class="collapse collapse-arrow join-item border-base-300 border">
      ...
      <div class="collapse-content">
        <p>Pour rencontrer les chiens en attente d&apos;adoption, présentez-vous durant nos <a href="nous-joindre.html"
    ...
    <div class="collapse collapse-arrow join-item border-base-300 border">
      ...
      <div class="collapse-content">
        ...
        <p>Un dépôt est exigé à l&apos;adoption d&apos;un chien (150 $). Ce montant est remboursable sur présentation
          d&apos;une preuve qu&apos;un cours d&apos;obéissance a été suivi avec un entraîneur certifié RQIEC, CTC, CPDT-KA, IAABC ou
          CSAT.</p>
      </div>
    </div>
  </div>
...
const catAdoptionCosts = `
  <h4 class="text-3xl uppercase font-medium mb-2 ml-1">Chats</h4>
  <div class="join join-vertical w-full rounded-none">
    <div class="collapse collapse-arrow join-item border-base-300 border">
...
const birdAdoptionCosts = `
  <h4 class="text-3xl uppercase font-medium mb-2 ml-1">Oiseaux</h4>
  <div class="join join-vertical w-full rounded-none">
    <div class="collapse collapse-arrow join-item border-base-300 border">
      <input type="radio" name="cats" checked="checked" />
      <div class="collapse-title text-xl uppercase text-[#E2992A] font-medium">Avant l'adoption</div>
...
const smallAnimalsAdoptionCosts = `
  <h4 class="text-3xl uppercase font-medium mb-2 ml-1">Petits Animaux</h4>
  <div class="join join-vertical w-full rounded-none">
    <div class="collapse collapse-arrow join-item border-base-300 border">
