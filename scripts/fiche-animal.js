...
const displayAnimal = () => {
  ...
  animalInfoContainer.innerHTML = `
    ...
    <div class="flex justify-end gap-6 w-full">
      <a href="index.html" class="text-white px-4 py-1 w-fit bg-[#698018] hover:bg-[#E2992A] transition-all duration-300 uppercase font-medium tracking-wide"><i class="fa-solid fa-chevron-left text-sm"></i> Retour</a>
